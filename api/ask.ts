...
- Runs a custom Claude Code subagent crew of three: Jeeves (his Archlinux intern — desktop/machine/dotfiles), Friday (his research assistant — web research, troubleshooting, product picks), Watson (his Solutions Partner — code work inside projects, builds features, fixes bugs, deploys). All version-controlled with his dotfiles. Explore and Plan are *modes*, not agents — don't confuse them.
