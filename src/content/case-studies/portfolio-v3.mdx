...
2. **Make the AI workflow legible.** Most "AI-native engineer" portfolios just say the words. Mine carries a dedicated Workflow section that names the crew (Jeeves, Watson, Friday), explains what each does, and links to the live config in my crew-quarters repo.
