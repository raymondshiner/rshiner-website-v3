...
2. **Make the AI workflow legible.** Most "AI-native engineer" portfolios just say the words. Mine carries a dedicated Workflow section that names the agents (Jeeves, Friday, Explore, Plan), explains what each does, and links to the live config in my dotfiles.
...
- **Content:** MDX for case studies and blog, statically resolved through Vite
...
- [`raymondshiner/dotfiles`](https://github.com/raymondshiner/dotfiles) — the Andromeda system this site extends
